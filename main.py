...
from tradovate_api import TradovateClient  # 🚀 Now using optimized client
import uvicorn
import httpx
import hashlib
...
if __name__ == "__main__":
    ...
    # 🚀 SPEED OPTIMIZATIONS - Windows compatible
    config = {
        "app": app,
        "host": "0.0.0.0", 
        "port": 8000,
    ...
    # Use uvloop only on Unix systems for best performance
